...
use frame_support::{derive_impl, parameter_types, traits::{AsEnsureOriginWithArg, OriginTrait}, BoundedVec};
...
pub fn new_test_ext() -> sp_io::TestExternalities {
    ...
    pallet_assets::GenesisConfig::<Test, Instance2> {
        ...
        accounts: vec![(1337, [4; 32].into(), 5_000)], // Genesis accounts: id, account_id, balance
        next_asset_id: None,
    }
    .assimilate_storage(&mut test)
    .unwrap();
